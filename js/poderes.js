const poderes = {
  ...
  avispa: {
    ...
    pasivos: [
      { nombre: 'Volar/Saltar/Trepar/Fase', descripcion: 'El personaje puede pasar por encima de obstáculos y enemigos para mover.' }
    ],
  },
  constrictor: {
    activos: [
  ...
  boomerang: {
    ...
    pasivos: [
      ...
      { nombre: 'Invulnerable a/d', descripcion: 'La resistencia del personaje en los ataques sufridos a distancia es de 2.' }
    ],
  },
  kingpin: {
    activos: [
  ...
  hulk: {
    ...
    pasivos: [
      ...
      { nombre: 'Invunerable', descripcion: 'La resistencia del personaje en los ataques sufridos c/c y a/d se aumenta en 2.' },
      { nombre: 'Regeneración', descripcion: 'El personaje recupera un 1 punto de vida tras finalizar su turno, siempre que esté por debajo de sus puntos de vida base.' }
    ],
  },
  maestroMarionetas: {

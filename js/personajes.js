...
const personajes = {
  ...
  blade: {
    ...
    habilidades: { activas: [], pasivas: ['Sigilo', 'Garras', 'Dureza'] }
  },
  lobaVenenosa: {
    ...
    habilidades: { activas: [], pasivas: ['Garras'] }
  },
  elektra: {
    nombre: 'Elektra',
    movimiento: 4,
    ...
    habilidades: { activas: [], pasivas: ['Sigilo', 'Garras'] }
  },
  avispa: {
    nombre: 'Avispa',
    movimiento: 4,
  ...
  dientesDeSable: {
    ...
    habilidades: { activas: [], pasivas: ['Sigilo', 'Garras', 'Dureza','Regeneración'] }
  },
  hulk: {
    nombre: 'Hulk',
    movimiento: 5,
  ...
  capitanAmerica: {
    ...
    habilidades: { activas: ['Mejora de Agilidad','Curar'], pasivas: ['Invulnerable a/d','Astucia','Dureza'] }
  },
  spiderMan: {
    nombre: 'Spider-Man',
    movimiento: 5,
  ...
  panteraNegra: {
    ...
    habilidades: { activas: [], pasivas: ['Volar/Saltar/Trepar/Fase','Astucia','Garras'] }
  },
  ventisca: {
    nombre: 'Ventisca',
    movimiento: 4,
  ...
  centinela: {
    ...
    habilidades: { activas: ['Incapacitar','Explosión'], pasivas: ['Dureza','Invulnerable a/d'] }
  }
};

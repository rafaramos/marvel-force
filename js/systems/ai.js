...
function evaluateCombatValue(key, stats, enemySelections) {
    ...
    if (hasPower(stats, 'Cuchillas/Garras/Colmillos')) value += 50;
    ...
    if (hasPower(stats, 'Experto a/d')) value += 50;
    ...
    if (hasPower(stats, 'Doble ataque c/c')) value += 20;
    if (hasPower(stats, 'Robo de vida')) value += 20;
